...
public:
    ...
    std::string toString() override {
        try {
            ...
            ALOTZ_LOG_ERROR(ALOTZ_LOG_ROOT()) << "ConfigVar::toString exception"
...
public:
    ...
    static typename ConfigVar<T>::ptr Lookup(const std::string& name,
        ...
        if (it != GetDatas().end()) {
            ...
            if (tmp) {
                ALOTZ_LOG_INFO(ALOTZ_LOG_ROOT()) << "Lookup name = " << name << "exists";
                return tmp;
            } else {
                ALOTZ_LOG_ERROR(ALOTZ_LOG_ROOT()) << "Lookup name = " << name << " exists but type not "
