#ifndef ALOTZ_DB_MYSQL_H
#define ALOTZ_DB_MYSQL_H
...
public:
    ...
    alotz::IStmt::ptr prepare(const std::string& sql) override;
...
typedef alotz::Singleton<MySQLManager> MySQLMgr;
