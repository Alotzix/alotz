...
int32_t FunctionServlet::handle(alotz::http::HttpRequest::ptr request
               , alotz::http::HttpResponse::ptr response
...
int32_t ServletDispatch::handle(alotz::http::HttpRequest::ptr request
               , alotz::http::HttpResponse::ptr response
               , alotz::http::HttpSession::ptr session) {
...
int32_t NotFoundServlet::handle(alotz::http::HttpRequest::ptr request
                   , alotz::http::HttpResponse::ptr response
                   , alotz::http::HttpSession::ptr session) {
    ...
    response->setStatus(alotz::http::HttpStatus::NOT_FOUND);
